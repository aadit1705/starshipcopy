"object" == typeof navigator && function(e, t) {
    ...
    var v, b, k, w = function() {
        function t(n, i) {
            e(this, t),
            g.element(n) ? this.element = n : g.string(n) && (this.element = document.querySelector(n)),
            g.element(this.element) && g.empty(this.element.rangeTouch) && (this.config = Object.assign({}, l, i),
            this.init())
        }
        return n(t, [{
            key: "init",
            ...
            key: "set",
            value: function(e) {
                t.enabled && g.event(e) && !e.target.disabled && (e.preventDefault(),
            ...
            value: function(e) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                  , i = null;
                if (g.empty(e) || g.string(e) ? i = Array.from(document.querySelectorAll(g.string(e) ? e : 'input[type="range"]')) : g.element(e) ? i = [e] : g.nodeList(e) ? i = Array.from(e) : g.array(e) && (i = e.filter(g.element)),
                g.empty(i))
                    return null;
        ...
        empty: M
    }, L = (v = document.createElement("span"),
    b = {
    ...
    function j() {
        ...
        return x.object(s) ? (Object.keys(s).forEach(function(t) {
            x.object(s[t]) ? (Object.keys(e).includes(t) || Object.assign(e, i({}, t, {})),
            j(e[t], s[t])) : Object.assign(e, i({}, t, s[t]))
        }),
    ...
    function D(e, t, n) {
        ...
        return x.object(t) && H(i, t),
        x.string(n) && (i.innerText = n),
        i
    }
    function F(e, t, n, i) {
    ...
    function B(e, t) {
        return x.element(t) && x.element(t.parentNode) && x.element(e) ? (t.parentNode.replaceChild(e, t),
        e) : null
    }
    function U(e, t) {
        if (!x.string(e) || x.empty(e))
            return {};
        var n = {}
          , i = j({}, t);
    ...
    function le(e) {
        ...
        null === n && !x.empty(this.embed) && x.array(this.embed.ratio) && (n = this.embed.ratio),
        null === n && this.isHTML5) {
            var i = this.media;
    ...
    var ue = {
        ...
        setup: function() {
            if (this.isHTML5) {
                ...
                Object.defineProperty(e.media, "quality", {
                    ...
                    set: function(t) {
                        if (e.quality !== t) {
                            if (e.config.quality.forced && x.function(e.config.quality.onChange))
        ...
        cancelRequests: function() {
            this.isHTML5 && (R(ue.getSources.call(this)),
    ...
    var ye = {
      ...
      , ve = function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ""
          , t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        if (x.empty(e) || x.empty(t))
            return "";
        var n = O(t.i18n, e);
        if (x.empty(n))
            return Object.keys(ye).includes(e) ? ye[e] : "";
        var i = {
            "{seektime}": t.seekTime,
            "{title}": t.title
        };
    ...
    var Se = {
        ...
        findElements: function() {
            try {
                return this.elements.controls = X.call(this, this.config.selectors.controls.wrapper),
                ...
                this.elements.progress = X.call(this, this.config.selectors.progress),
                ...
                x.element(this.elements.progress) && (this.elements.display.seekTooltip = this.elements.progress.querySelector(".".concat(this.config.classNames.tooltip))),
                !0
            } catch (e) {
        ...
        createButton: function(e, t) {
            ...
            H(r, i),
            "play" === a ? (x.array(this.elements.buttons[a]) || (this.elements.buttons[a] = []),
        ...
        updateVolume: function() {
            this.supported.ui && (x.element(this.elements.inputs.volume) && Se.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
            x.element(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume))
        },
        setRange: function(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
            x.element(e) && (e.value = t,
        ...
        updateSeekTooltip: function(e) {
            ...
            if (this.config.tooltips.seek && x.element(this.elements.inputs.seek) && x.element(this.elements.display.seekTooltip) && 0 !== this.duration) {
                ...
                if (this.touch)
                    ...
                    a < 0 ? a = 0 : a > 100 && (a = 100),
                    Se.updateTimeDisplay.call(this, this.elements.display.seekTooltip, this.duration / 100 * a),
                    this.elements.display.seekTooltip.style.left = "".concat(a, "%"),
                    x.event(e) && ["mouseenter", "mouseleave"].includes(e.type) && i("mouseenter" === e.type)
                }
            }
        },
        ...
        durationUpdate: function() {
            if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
                if (this.duration >= Math.pow(2, 32))
                    return W(this.elements.display.currentTime, !0),
        ...
        updateSetting: function(e, t, n) {
            ...
            if (x.element(s) || (s = i && i.querySelector('[role="menu"]')),
            x.element(s)) {
        ...
        setQualityMenu: function(e) {
            ...
            if (x.element(this.elements.settings.panels.quality)) {
                ...
                if (Se.toggleMenuButton.call(this, "quality", i),
                V(n),
        ...
        setCaptionsMenu: function() {
            ...
            if (x.element(this.elements.settings.panels.captions)) {
                var t = this.elements.settings.panels.captions.querySelector('[role="menu"]')
                  ...
                  , i = Boolean(n.length);
                if (Se.toggleMenuButton.call(this, "captions", i),
                V(t),
                Se.checkMenu.call(this),
                i) {
        ...
        toggleMenu: function(e) {
            ...
            if (x.element(t) && x.element(n)) {
                ...
                if (x.boolean(e))
                    a = e;
                else if (x.keyboardEvent(e) && 27 === e.which)
                    a = !1;
                else if (x.event(e)) {
                ...
                a && x.keyboardEvent(e) ? Se.focusFirstMenuItem.call(this, null, !0) : a || i || J.call(this, n, x.keyboardEvent(e))
            }
        },
        ...
        showMenuPanel: function() {
            ...
            if (x.element(i)) {
                ...
                W(s, !0),
                W(i, !1),
                Se.focusFirstMenuItem.call(this, i, n)
            }
        },
            ...
            return de(this.config.controls).forEach(function(o) {
                ...
                "settings" === o && !x.empty(t.config.settings)) {
                    ...
                    t.config.settings.forEach(function(i) {
                        ...
                        ne.call(t, o, "keydown", function(e) {
                ...
                if ("pip" === o && Z.pip && u.appendChild(i.call(t, "pip", d)),
                "airplay" === o && Z.airplay && u.appendChild(i.call(t, "airplay", d)),
                "download" === o) {
                    var w = j({}, d, {
                        element: "a",
                        href: t.download,
        ...
        inject: function() {
            ...
            var i = {
              ...
              , a = !0;
            x.function(this.config.controls) && (this.config.controls = this.config.controls.call(this, i)),
            this.config.controls || (this.config.controls = []),
            x.element(this.config.controls) || x.string(this.config.controls) ? n = this.config.controls : (n = Se.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
            ...
            if (a && (x.string(this.config.controls) ? n = o(n) : x.element(n) && (n.innerHTML = o(n.innerHTML))),
            x.string(this.config.selectors.controls.container) && (s = document.querySelector(this.config.selectors.controls.container)),
            x.element(s) || (s = this.elements.container),
            s[x.element(n) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", n),
    ...
    var Me = {
        setup: function() {
            if (this.supported.ui)
                if (!this.isVideo || this.isYouTube || this.isHTML5 && !Z.textTracks)
                    x.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && Se.setCaptionsMenu.call(this);
                else {
                    var e, t;
                    if (x.element(this.elements.captions) || (this.elements.captions = D("div", U(this.config.selectors.captions)),
                    e = this.elements.captions,
                    t = this.elements.wrapper,
                    x.element(e) && x.element(t) && t.parentNode.insertBefore(e, t.nextSibling)),
                    _.isIE && window.URL) {
                    ...
                    if (x.boolean(s) || (s = this.config.captions.active),
        ...
        update: function() {
            ...
            (o && this.language !== a || !t.includes(r)) && (Me.setLanguage.call(this, a),
            Me.toggle.call(this, i && o)),
            z(this.elements.container, this.config.classNames.captions.enabled, !x.empty(t)),
        ...
        toggle: function(e) {
            ...
            if (this.supported.ui) {
                ...
                if (a !== n) {
                    ...
                    se.call(this, this.media, a ? "captionsenabled" : "captionsdisabled")
                }
            }
        },
        set: function(e) {
        ...
        findTrack: function(e) {
            var t, n = this, i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], a = Me.getTracks.call(this), s = function(e) {
        ...
        getLabel: function(e) {
            var t = e;
            return !x.track(t) && Z.textTracks && this.captions.toggled && (t = Me.getCurrentTrack.call(this)),
            x.track(t) ? x.empty(t.label) ? x.empty(t.language) ? ve("enabled", this.config) : e.language.toUpperCase() : t.label : ve("disabled", this.config)
        },
    ...
    var je = function() {}
      ...
      , He = function() {
        function t(n) {
            ...
            ne.call(this.player, document, "ms" === this.prefix ? "MSFullscreenChange" : "".concat(this.prefix, "fullscreenchange"), function() {
                i.onChange()
            }),
        ...
        return n(t, [{
            ...
            value: function() {
                if (this.enabled) {
                    ...
                    se.call(this.player, this.target, this.active ? "enterfullscreen" : "exitfullscreen", !0)
                }
            }
        }, {
            key: "toggleFallback",
            ...
            get: function() {
                ...
                return ["webkit", "moz", "ms"].some(function(t) {
                    return !(!x.function(document["".concat(t, "ExitFullscreen")]) && !x.function(document["".concat(t, "CancelFullScreen")])) && (e = t,
                    !0)
                }),
                e
            }
    ...
    var Fe = {
        ...
        build: function() {
            ...
            x.element(this.elements.controls) || (Se.inject.call(this),
            ...
            z(this.elements.container, this.config.classNames.pip.supported, Z.pip && this.isHTML5 && this.isVideo),
            z(this.elements.container, this.config.classNames.airplay.supported, Z.airplay && this.isHTML5),
        ...
        setTitle: function() {
            ...
            if (x.string(this.config.title) && !x.empty(this.config.title) && (e += ", ".concat(this.config.title)),
        ...
        setPoster: function(e) {
            ...
            this.isHTML5 ? Promise.resolve(e) : function() {
                var e = this;
      ...
      , Re = function() {
        ...
        return n(t, [{
            ...
            value: function() {
                var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0]
                  , t = this.player;
                t.config.keyboard.global && te.call(t, window, "keydown keyup", this.handleKey, e, !1),
                te.call(t, document.body, "click", this.toggleMenu, e),
                ae.call(t, document.body, "touchstart", this.firstTouch),
                te.call(t, document.body, "keydown focus blur", this.setTabFocus, e, !1, !0)
            }
        }, {
            key: "container",
            value: function() {
                var e = this.player
                  ...
                  , n = e.elements
                  , i = e.timers;
                !t.keyboard.global && t.keyboard.focused && ne.call(e, n.container, "keydown keyup", this.handleKey, !1),
                ne.call(e, n.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", function(t) {
                    var a = n.controls;
                        ...
                        !function(t, n, i) {
                            if (e.isVimeo) {
                                var a = e.elements.wrapper.firstChild
                                  ...
                                  , l = o[0]
                                  , c = o[1];
                                a.style.maxWidth = i ? "".concat(s / c * l, "px") : null,
                                a.style.margin = i ? "0 auto" : null
                            }
                        }(u.ratio, 0, c),
                        l || (c ? ne.call(e, window, "resize", s) : ie.call(e, window, "resize", s))
                    }
                })
            }
        }, {
            ...
            value: function() {
                ...
                this.bind(n.buttons.settings, "keyup", function(e) {
                    ...
                    e.stopPropagation(),
                    Se.toggleMenu.call(t, e)) : Se.focusFirstMenuItem.call(t, null, !0))
                }, null, !1),
    ...
    var Ve, Be = (function(e, t) {
        e.exports = function() {
            ...
            function r(t, n, i, a) {
                var s, o, l = document, c = i.async, u = (i.numRetries || 0) + 1, d = i.before || e, h = t.replace(/[\?|#].*$/, ""), m = t.replace(/^(css|img)!/, "");
                a = a || 0,
                /(^css!|\.css$)/.test(h) ? ((o = l.createElement("link")).rel = "stylesheet",
                o.href = m,
                (s = "hideFocus"in o) && o.relList && (s = 0,
                o.rel = "preload",
                o.as = "style")) : /(^img!|\.(png|gif|jpg|svg|webp)$)/.test(h) ? (o = l.createElement("img")).src = m : ((o = l.createElement("script")).src = t,
                o.async = void 0 === c || c),
    ...
    var ze = {
        setup: function() {
            ...
            e.options.speed = e.config.speed.options,
            ce.call(e),
            x.object(window.Vimeo) ? ze.ready.call(e) : Ue(e.config.urls.vimeo.sdk).then(function() {
                ze.ready.call(e)
            }).catch(function(t) {
        ...
        ready: function() {
            ...
            var s, o = (s = a,
            x.empty(s) ? null : x.number(Number(s)) ? s : s.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : s), l = D("iframe"), c = he(t.config.urls.vimeo.iframe, o, i);
            l.setAttribute("src", c),
            l.setAttribute("allowfullscreen", ""),
            l.setAttribute("allowtransparency", ""),
            l.setAttribute("allow", "autoplay"),
            x.empty(n.referrerPolicy) || l.setAttribute("referrerPolicy", n.referrerPolicy);
            var u = D("div", {
                poster: t.poster,
            ...
            Object.defineProperty(t.media, "volume", {
                ...
                set: function(e) {
                    t.embed.setVolume(e).then(function() {
                        m = e,
                        se.call(t, t.media, "volumechange")
                    })
                }
            });
            ...
            t.embed.on("progress", function(e) {
                ...
                1 === parseInt(e.percent, 10) && se.call(t, t.media, "canplaythrough"),
                t.embed.getDuration().then(function(e) {
            ...
            t.embed.on("seeked", function() {
                t.media.seeking = !1,
                se.call(t, t.media, "seeked")
            }),
            t.embed.on("ended", function() {
                t.media.paused = !0,
                se.call(t, t.media, "ended")
            }),
            t.embed.on("error", function(e) {
                t.media.error = e,
                se.call(t, t.media, "error")
            }),
            setTimeout(function() {
    ...
    var Qe = {
        ...
        ready: function() {
            ...
            if (x.empty(t) || !t.startsWith("youtube-")) {
                ...
                var i, a, s = (i = n,
                x.empty(i) ? null : i.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : i), r = (a = e.provider,
                "".concat(a, "-").concat(Math.floor(1e4 * Math.random()))), o = D("div", {
                    id: r,
                    poster: e.poster
                });
                e.media = B(o, e.media);
                    ...
                    events: {
                        ...
                        onReady: function(t) {
                            if (!x.function(e.media.play)) {
                                ...
                                e.timers.buffering = setInterval(function() {
                                    ...
                                    (null === e.media.lastBuffered || e.media.lastBuffered < e.media.buffered) && se.call(e, e.media, "progress"),
                        ...
                        onStateChange: function(t) {
                            ...
                            case 0:
                                ...
                                n.playVideo()) : se.call(e, e.media, "ended");
                                break;
                            case 1:
                                e.config.autoplay || !e.media.paused || e.embed.hasPlayed ? (Ke.call(e, !0),
                                ...
                                se.call(e, e.media, "durationchange"))) : e.media.pause();
                                break;
                            case 2:
      ...
      , Xe = {
        setup: function() {
            ...
            this.isVideo && (this.elements.wrapper = D("div", {
                class: this.config.classNames.video
            }),
            q(this.media, this.elements.wrapper),
            this.isEmbed && (this.elements.poster = D("div", {
                class: this.config.classNames.poster
            }),
            this.elements.wrapper.appendChild(this.elements.poster))),
            this.isHTML5 ? ue.setup.call(this) : this.isYouTube ? Qe.setup.call(this) : this.isVimeo && ze.setup.call(this)) : this.debug.warn("No media element found!")
        }
    }
      , Je = function() {
        function t(n) {
        ...
        return n(t, [{
            ...
            key: "onAdEvent",
            value: function(e) {
                var t, n = this, i = this.player.elements.container, a = e.getAd(), s = e.getAdData();
                switch (t = e.type,
                se.call(n.player, n.player.media, "ads".concat(t.replace(/_/g, "").toLowerCase())),
                e.type) {
                case google.ima.AdEvent.Type.LOADED:
                    this.trigger("loaded"),
                    this.pollCountdown(!0),
                    a.isLinear() || (a.width = i.offsetWidth,
            ...
            key: "on",
            value: function(e, t) {
                return x.array(this.events[e]) || (this.events[e] = []),
            ...
            value: function(e) {
                x.nullOrUndefined(this.safetyTimer) || (this.player.debug.log("Safety timer cleared from: ".concat(e)),
      ...
      , Ge = function() {
        ...
        return n(t, [{
            ...
            key: "startScrubbing",
            value: function(e) {
                (x.nullOrUndefined(e.button) || !1 === e.button || 0 === e.button) && (this.mouseDown = !0,
            ...
            value: function() {
                var e = this;
                this.mouseDown = !1,
                Math.ceil(this.lastTime) === Math.ceil(this.player.media.currentTime) ? this.toggleScrubbingContainer(!1) : ae.call(this.player, this.player.media, "timeupdate", function() {
            ...
            value: function() {
                ...
                x.element(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container),
      ...
      , Ze = {
        ...
        change: function(e) {
            var t = this;
            O(e, "sources.length") ? (ue.cancelRequests.call(this),
            this.destroy.call(this, function() {
                t.options.quality = [],
                R(t.media),
                t.media = null,
                x.element(t.elements.container) && t.elements.container.removeAttribute("class");
                var n = e.sources
                  , i = e.type
                  , a = r(n, 1)[0]
                  , s = a.provider
                ...
                Xe.setup.call(t),
                t.isHTML5 && Object.keys(e).includes("tracks") && Ze.insertElements.call(t, "track", e.tracks),
                (t.isHTML5 || t.isEmbed && !t.supported.ui) && Fe.build.call(t),
                t.isHTML5 && t.media.load(),
                x.empty(e.previewThumbnails) || (Object.assign(t.config.previewThumbnails, e.previewThumbnails),
                t.previewThumbnails && t.previewThumbnails.loaded && (t.previewThumbnails.destroy(),
                t.previewThumbnails = null),
                t.config.previewThumbnails.enabled && (t.previewThumbnails = new Ge(t))),
                t.fullscreen.update()
    ...
    var et, tt = function() {
        function t(n, i) {
            ...
            this.touch = Z.touch,
            this.media = n,
            x.string(this.media) && (this.media = document.querySelectorAll(this.media)),
            (window.jQuery && this.media instanceof jQuery || x.nodeList(this.media) || x.array(this.media)) && (this.media = this.media[0]),
            this.config = j({}, xe, t.defaults, i || {}, function() {
                try {
                ...
                if (this.media.plyr)
                    ...
                    if (Z.check().api) {
                        ...
                        case "div":
                            ...
                            if (x.empty(this.provider) || !Object.keys(_e).includes(this.provider))
                        ...
                        this.supported = Z.check(this.type, this.provider, this.config.playsinline),
                        this.supported.api ? (this.eventListeners = [],
                        this.listeners = new Re(this),
                        this.storage = new be(this),
                        this.media.plyr = this,
                        x.element(this.elements.container) || (this.elements.container = D("div", {
                            tabindex: 0
                        }),
                        q(this.media, this.elements.container)),
                        Fe.addStyleHook.call(this),
                        Xe.setup.call(this),
                        this.config.debug && ne.call(this, this.elements.container, this.config.events.join(" "), function(e) {
                        ...
                        this.lastSeekTime = 0,
                        this.config.previewThumbnails.enabled && (this.previewThumbnails = new Ge(this))) : this.debug.error("Setup failed: no support")
                    } else
        ...
        return n(t, [{
            ...
            value: function() {
                ...
                this.restart()) : x.function(this.media.stop) && this.media.stop()
            }
        }, {
            key: "restart",
            value: function() {
            ...
            value: function(e) {
                if (this.supported.ui && !this.isAudio) {
                    ...
                    if (i && this.config.controls.includes("settings") && !x.empty(this.config.settings) && Se.toggleMenu.call(this, !1),
                    i !== t) {
            ...
            value: function(e) {
                ...
                if (this.ready) {
                    var i = function() {
                        ...
                        t.embed = null,
                        n ? (Object.keys(t.elements).length && (R(t.elements.buttons.play),
                    ...
                    null !== this.embed && x.function(this.embed.destroy) && this.embed.destroy(),
            ...
            set: function(e) {
                x.url(e) && (this.config.urls.download = e,
            ...
            set: function(e) {
                this.isVideo ? x.string(e) && re(e) ? (this.config.ratio = e,
                ce.call(this)) : this.debug.error("Invalid aspect ratio specified (".concat(e, ")")) : this.debug.warn("Aspect ratio can only be set for video")
            }
        }, {
            key: "autoplay",
            set: function(e) {
            ...
            set: function(e) {
                if (Z.pip) {
                    ...
                    x.function(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? Le : Ie),
                    x.function(this.media.requestPictureInPicture) && (!this.pip && t ? this.media.requestPictureInPicture() : this.pip && !t && document.exitPictureInPicture())
                }
            },
            get: function() {
            ...
            value: function(e) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                  , i = null;
                return x.string(e) ? i = Array.from(document.querySelectorAll(e)) : x.nodeList(e) ? i = Array.from(e) : x.array(e) && (i = e.filter(x.element)),
                x.empty(i) ? null : i.map(function(e) {
                    return new t(e,n)
                })
            }
        }]),
